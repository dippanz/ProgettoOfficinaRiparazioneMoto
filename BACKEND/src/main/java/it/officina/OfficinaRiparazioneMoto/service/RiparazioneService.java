...
public interface RiparazioneService {
         ...
         * @throws BadRequestException if the required repair state is not found and if
         *                             a repair with same moto is still not completed
         */
         ...
         *                                  provided
         */
        List<RiparazioneMotoClienteDto> getListaRiparazioniMotoClienteDto(UUID idUtenteReg, UUID idUtenteMec,
                        int... stati)
